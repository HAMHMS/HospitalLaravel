...
<div align="center" style="padding:70px;">
	<table>
		<tr style="background-color:black;">
			...
			<th style="padding:10px; font-size: 20px; color: white;">Delete Appointment</th>
		</tr>
		...
		<tr style="background-color:black;" align="center">
			...
			<td><a class="btn btn-danger" onclick="return confirm('are you shure to delete this ?')" href="{{url('cancel_appoint',$appoints->id)}}">Delete</a></td>
		</tr>
		@endforeach
	</table>
</div>
